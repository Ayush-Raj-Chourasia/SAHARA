...
// For Vite, we can also use 'export default' at the end or on the function.
    ...
    <div className="min-h-screen bg-white text-[#111827] font-['Outfit',sans-serif] overflow-x-hidden selection:bg-[#EA580C] selection:text-white">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-4 bg-red-50 text-red-600 rounded-2xl border border-red-100">
                <div className="flex items-center gap-2">
                  <LandingIcons.AlertTriangle w={18} />
      ...
      <section className="py-32 px-6 mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6 relative">
          {[
            { step: "01", icon: <LandingIcons.Mic />, label: "Log food via Voice", color: "border-orange-500" },
            { step: "02", icon: <LandingIcons.Activity />, label: "AI Analyzes Nutrition", color: "border-green-500" },
            { step: "03", icon: <LandingIcons.Check />, label: "Score Updates", color: "border-[#111827]" },
            { step: "04", icon: <LandingIcons.AlertTriangle />, label: "Risk Detected", color: "border-red-500" },
            { step: "05", icon: <LandingIcons.Shield />, label: "Family Notified", color: "border-blue-500" },
            { step: "06", icon: <LandingIcons.Activity />, label: "Care Provided", color: "border-amber-500" }
          ].map((item, i) => (
      ...
      <section className="py-32 bg-gray-50">
        <div className="px-6 mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: <LandingIcons.Activity />, title: "AI Nutrition", desc: "Indian food analysis via Gemini AI." },
              { icon: <LandingIcons.Shield />, title: "Health Score", desc: "Predictive 0–100 overall score." },
              { icon: <LandingIcons.AlertTriangle />, title: "Anaemia Engine", desc: "Early warning for iron deficiency." },
              { icon: <LandingIcons.Activity />, title: "SOS Alerts", desc: "One-tap emergency SMS with GPS." },
              { icon: <LandingIcons.Shield />, title: "Family Dashboard", desc: "Live monitoring from any city." },
              { icon: <LandingIcons.Mic />, title: "Voice First", desc: "Supports Hindi & Odia inputs." }
            ].map((feature, i) => (
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button onClick={onStart} className="w-full sm:w-auto px-12 py-6 bg-[#EA580C] text-white rounded-full text-xl font-black shadow-2xl shadow-[#EA580C]/30 hover:shadow-[#EA580C]/50 hover:-translate-y-1 transition-all flex items-center justify-center gap-3">
              Start Free Today <LandingIcons.ArrowRight w={24} />
            </button>
          </div>
        </div>
      </section>
  ...
  return (
    <div className="min-h-screen bg-white text-[#111827] font-['Outfit',sans-serif] flex flex-col items-center justify-center p-6 selection:bg-[#EA580C] selection:text-white">
      ...
      <button onClick={onBack} className="absolute top-10 left-10 p-2 hover:bg-gray-100 rounded-full transition-colors flex items-center gap-2 font-bold text-sm">
        <LoginIcons.ArrowLeft w={20} /> Back
      </button>
