...
export const AuthProvider = ({ children }) => {
    ...
    const loginAsDemo = (role = 'senior') => {
        ...
        localStorage.setItem('sahara_token', 'demo-token');
        persistUser(demoUser);
        console.log('[AUTH] Demo login successful as:', role);
        return demoUser;
    };
    ...
    return (
        <AuthContext.Provider value={{ user, login, register, googleSignIn, logout, loading, completeOnboarding, linkFamily, loginAsDemo }}>
            {children}
