...
function SAHARA() {
    ...
    const score = (() => {
        ...
        if (hbVal < 11) s -= 15; // Anaemia threshold
        ...
        <main style={{ maxWidth: 1120, margin: "0 auto", padding: "24px 18px 180px", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(min(100%,480px),1fr))", gap: 18 }}>
            ...
            <Card th={th} d={5} show={show}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 11, marginTop: 15 }}>
                    {Number(vitals.hb) < 12 && <AlertRow th={th} dark={dark} sev="warn" title="Anaemia Risk Detected" desc="HB levels are low. Consider iron-rich foods like spinach, lentils, and dates. Consult your doctor." />}
