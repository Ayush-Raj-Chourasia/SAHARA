...
function LoginPage({ onLogin }) {
    ...
    return (
        <div style={{ minHeight: "100vh", background: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 24px", fontFamily: "'Outfit', sans-serif" }}>
            ...
            <div className="lu" style={{ animationDelay: ".05s", width: "100%", maxWidth: 420, textAlign: "center" }}>
                ...
                <form onSubmit={handleLogin}>
                    <input id="login-email" className="lgn-inp" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Email address"
                        style={{ width: "100%", padding: "13px 16px", borderRadius: 12, border: "1.5px solid #E4E2DB", background: "#F5F4F0", fontSize: 15, fontFamily: "'Outfit',sans-serif", color: "#131313", outline: "none", marginBottom: 10, boxSizing: "border-box", transition: "all .15s", textAlign: "center" }} required />
                    <div style={{ position: "relative", marginBottom: 14 }}>
                        <input id="login-pass" className="lgn-inp" type={showPass ? "text" : "password"} value={pass} onChange={e => setPass(e.target.value)} placeholder="Password"
                            style={{ width: "100%", padding: "13px 56px 13px 16px", borderRadius: 12, border: "1.5px solid #E4E2DB", background: "#F5F4F0", fontSize: 15, fontFamily: "'Outfit',sans-serif", color: "#131313", outline: "none", boxSizing: "border-box", transition: "all .15s", textAlign: "center" }} required />
                ...
                <div style={{ marginTop: 24, padding: "13px 15px", background: "#F5F4F0", borderRadius: 12, border: "1.5px solid #E4E2DB", textAlign: "center" }}>
            ...
            <p className="lu" style={{ animationDelay: ".12s", marginTop: 36, fontSize: 11, color: "rgba(0,0,0,.22)", textAlign: "center" }}>© SAHARA.ai powered elderly care &nbsp;·&nbsp; Built by team <strong style={{fontWeight:700,color:"rgba(0,0,0,.4)"}}>IDIOTICS</strong> for <strong style={{fontWeight:700,color:"rgba(0,0,0,.4)"}}>TRITHON 2026</strong></p>
        </div>
    );
}
