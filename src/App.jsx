...
function LoginPage({ onLogin }) {
    ...
    return (
        <div style={{ minHeight: "100vh", background: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 24px", fontFamily: "'Outfit', sans-serif" }}>
            ...
            <p className="lu" style={{ animationDelay: ".12s", marginTop: 36, fontSize: 11, color: "rgba(0,0,0,.22)" }}>© SAHARA.ai powered elderly care &nbsp;·&nbsp; Built by team <strong style={{fontWeight:700,color:"rgba(0,0,0,.4)"}}>IDIOTICS</strong> for <strong style={{fontWeight:700,color:"rgba(0,0,0,.4)"}}>TRITHON 2026</strong></p>
        </div>
    );
}
